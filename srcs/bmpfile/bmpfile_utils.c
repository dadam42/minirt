...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/04/19 17:48:10 by damouyal          #+#    #+#             */
/*   Updated: 2020/04/19 17:50:36 by damouyal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	t_bmpfile_set_header(t_bmpfile *bmpfile, t_sys *sys)
{
	...
	out = bmpfile->info.height * (3 * bmpfile->info.width + bmpfile->padding)
			+ 54;
...
static void	t_bmpfile_set_infoheader(t_bmpfile *bmpfile, t_sys *sys)
{
	...
	sys->dump_to_little_endian(&bmpfile->infoheader[4]
		, &bmpfile->info.width, 4);
	sys->dump_to_little_endian(&bmpfile->infoheader[8]
		, &bmpfile->info.height, 4);
