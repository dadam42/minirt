...
t_object	*t_scene_object_iterator_deref(t_scene_object_iterator *iterator)
{
	return ((t_object*)
...
bool		t_scene_object_iterator_next(t_scene_object_iterator *iterator)
{
					...
					, t_scene_object_iterator* iterator)
{
	t_array_collection_init_fwiterator(&scene->object_collection
							, (t_array_collection_iterator*)iterator);
	iterator->next = t_scene_object_iterator_next;
	iterator->deref = t_scene_object_iterator_deref;
}
