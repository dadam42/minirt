...
#include "test.h"
#define NTEST 9
#define T_TEST t_filert_color
#define PRINTF	t_filert_color_printf
#define EQUAL	t_filert_color_equal
#include <stdio.h>

int main()
{
	char 					*test_str[NTEST] = { "0,0,0", "0,1,2", "42,42,42", " \v42\t, \v42 ,\t42", "255,255,255"
		, "-2, 56, 21", "0, 258, 0", "12, 12, -45", "fdnvkqj"};
	t_filert_parser_com		expected_ret[NTEST] = {filert_internal, filert_internal, filert_internal, filert_internal, filert_internal
		,filert_error, filert_error, filert_error, filert_error	};
	t_filert_parser_com		ret;
	T_TEST					expected_parsed[NTEST] = {{0,0,0}, {0,1,2}, {42,42,42}, {42,42,42}, {255,255,255}
